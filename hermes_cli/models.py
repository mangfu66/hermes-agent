...
def validate_requested_model(
    ...
    *,
    ...
    if normalized in {"openai-codex", "xai-oauth", "google-gemini-cli", "google-gemini-acp", "google-antigravity"}:
        try:
        ...
        if catalog_models:
            ...
            if normalized == "openai-codex":
                ...
                accept_hidden_model = False
                message_text = f"Model `{requested}` was not found in the {provider_label} model listing."
                ...
                message_text = f"Model `{requested}` was not found in the {provider_label} model listing."
            return {
                "accepted": accept_hidden_model,
                "persist": accept_hidden_model,
                "recognized": False,
                "message": f"{message_text}{suggestion_text}",
            }
