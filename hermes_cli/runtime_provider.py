...
def _resolve_runtime_from_pool_entry(
    *,
    ...
    elif provider in ("google-gemini-cli", "google-antigravity"):
        api_mode = "chat_completions"
    ...
    *,
    ...
    if provider == "claude-acp":
        ...
        return {
            "provider": "claude-acp",
            "api_mode": "chat_completions",
            "base_url": creds.get("base_url", "").rstrip("/") or "acp://claude-code",
            "api_key": creds.get("api_key", "") or "claude-acp",
            "command": creds.get("command", "") or "claude",
